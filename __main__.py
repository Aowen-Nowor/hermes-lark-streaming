...
def _bootstrap_package() -> None:
    ...
    print(
        ...
        "\n"
        "Possible fixes:\n"
        "  1. Run directly:     $HERMES_PYTHON /path/to/hermes-lark-streaming/__main__.py status\n"
        "  2. Set PYTHONPATH:   PYTHONPATH=~/.hermes/plugins $HERMES_PYTHON -m hermes_lark_streaming status",
        file=sys.stderr,
    )
